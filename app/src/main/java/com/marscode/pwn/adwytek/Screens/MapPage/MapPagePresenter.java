...
public class MapPagePresenter implements MapPageInterface.MapPagePresentation {
    ...
    MapPagePresenter(MapPageInteractor mapPageInteractor, MapPageInterface.MapPageView mapPageView) {
    ...
    public void setPharmacies(List<Geometry> geometries) {
        mMapPageView.showNearByLocOnMap(geometries);
    }
}
